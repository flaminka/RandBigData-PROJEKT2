...
Dane, które dostaliśmy miały postać:
...
Przefiltrowaliśmy z nich dane dla banku AliorBank oraz poprawiliśmy ortografię i dokonaliśmy rozkładu gramatycznego kolumny **body** za pomocą poniższej funkcji:
