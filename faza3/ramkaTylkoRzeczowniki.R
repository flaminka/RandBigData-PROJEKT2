...
#' 
#' @param sciezka_dane ścieżka dostępu do danych typu .csv, dane muszą być 
...
#' danych
#' @example ramkaTylkoRzeczowniki(SciezkaDane, SciezkaZapis,
#' "daneAlior", "https://www.facebook.com/AliorBankSA") 
#' @import httr, dplyr, stringi, doParallel
#' @export
